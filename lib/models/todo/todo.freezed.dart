...
abstract class $TodoCopyWith<$Res> {
  ...
  $Res call(
      {String id, String title, @JsonKey(defaultValue: false) bool? completed});
}
...
class _$_Todo implements _Todo {
  const _$_Todo(
      {required this.id,
      required this.title,
      @JsonKey(defaultValue: false) this.completed});
...
abstract class _Todo implements Todo {
  const factory _Todo(
      ...
      @JsonKey(defaultValue: false) final bool? completed}) = _$_Todo;
